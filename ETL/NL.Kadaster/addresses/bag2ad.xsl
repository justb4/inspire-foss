...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<xsl:apply-templates select="//bag_LVC:Nummeraanduiding"/>
	...
	<xsl:template match="bag_LVC:Nummeraanduiding">
		...
		<xsl:call-template name="insert_ad_locator">
			...
			<xsl:with-param name="value">
				<xsl:value-of select='bag_LVC:huisnummer'/><xsl:value-of select='bag_LVC:huisletter'/><xsl:value-of select='bag_LVC:huisnummertoevoeging'/>
			</xsl:with-param>
