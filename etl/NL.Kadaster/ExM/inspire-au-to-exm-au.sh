...
cp $1 $2
$REPSTR 'xmlns:AU="urn:x-inspire:specification:gmlas:AdministrativeUnits:3.0"' 'xmlns:AU="urn:x-inspire:specification:gmlas:AdministrativeUnits:3.0" xmlns:XAU="urn:x-exml:specification:gmlas:ExMLargeAdministrativeUnits:1.0"' $2
