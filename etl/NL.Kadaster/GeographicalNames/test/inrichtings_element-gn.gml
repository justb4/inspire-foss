...
<base:SpatialDataSet xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gml2="http://www.opengis.net/gml" xmlns:ogr="http://ogr.maptools.org/" xmlns:wfs="http://www.opengis.net/wfs" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:BaseTypes:3.2 http://schemas.kademo.nl/inspire/v3.0.1/BaseTypes.xsd         urn:x-inspire:specification:gmlas:GeographicalNames:3.0 http://schemas.kademo.nl/inspire/v3.0.1/GeographicalNames.xsd" gml:id="NL.KAD.GN">
  ...
  <base:member xmlns:GN="urn:x-inspire:specification:gmlas:GeographicalNames:3.0">
    <GN:NamedPlace gml:id="NL.KAD.GN.NL.TOP10NL.118567824">
      <gml:identifier codeSpace="http://inspire.jrc.ec.europa.eu/">urn:x-inspire:object:id:NL.KAD.GN.NL.TOP10NL.118567824</gml:identifier>
      ...
      <GN:inspireId>
        <base:Identifier>
          <base:localId>NL.TOP10NL.118567824</base:localId>
          <base:namespace>NL.KAD.GN</base:namespace>
        </base:Identifier>
      </GN:inspireId>
      <GN:localType>
  ...
  <base:member xmlns:GN="urn:x-inspire:specification:gmlas:GeographicalNames:3.0">
    <GN:NamedPlace gml:id="NL.KAD.GN.NL.TOP10NL.117867883">
      <gml:identifier codeSpace="http://inspire.jrc.ec.europa.eu/">urn:x-inspire:object:id:NL.KAD.GN.NL.TOP10NL.117867883</gml:identifier>
      <GN:beginLifespanVersion xsi:nil="true" nilReason="UNKNOWN"/>
      <GN:endLifespanVersion xsi:nil="true" nilReason="UNKNOWN"/>
      <GN:geometry>
      ...
      <GN:inspireId>
        <base:Identifier>
          <base:localId>NL.TOP10NL.117867883</base:localId>
          <base:namespace>NL.KAD.GN</base:namespace>
        </base:Identifier>
      </GN:inspireId>
      <GN:localType>
  ...
  <base:member xmlns:GN="urn:x-inspire:specification:gmlas:GeographicalNames:3.0">
    <GN:NamedPlace gml:id="NL.KAD.GN.NL.TOP10NL.117872819">
      <gml:identifier codeSpace="http://inspire.jrc.ec.europa.eu/">urn:x-inspire:object:id:NL.KAD.GN.NL.TOP10NL.117872819</gml:identifier>
      <GN:beginLifespanVersion xsi:nil="true" nilReason="UNKNOWN"/>
      <GN:endLifespanVersion xsi:nil="true" nilReason="UNKNOWN"/>
      <GN:geometry>
      ...
      <GN:inspireId>
        <base:Identifier>
          <base:localId>NL.TOP10NL.117872819</base:localId>
          <base:namespace>NL.KAD.GN</base:namespace>
        </base:Identifier>
      </GN:inspireId>
      <GN:localType>
      ...
      <GN:relatedSpatialObject xsi:nil="true" nilReason="other:unpopulated"/>
      <GN:type codeSpace="http://schemas.kademo.nl/inspire/codelist-1004/NamedPlaceTypeValue.xml">building</GN:type>
    </GN:NamedPlace>
  </base:member>
</base:SpatialDataSet>
