...
<base:SpatialDataSet xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:HY-P="urn:x-inspire:specification:gmlas:HydroPhysicalWaters:3.0" xmlns:GN="urn:x-inspire:specification:gmlas:GeographicalNames:3.0" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:gml2="http://www.opengis.net/gml" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:ogr="http://ogr.maptools.org/" xmlns:wfs="http://www.opengis.net/wfs" xsi:schemaLocation="urn:x-inspire:specification:gmlas:BaseTypes:3.2 http://schemas.kademo.nl/inspire/v3.0.1/BaseTypes.xsd urn:x-inspire:specification:gmlas:GeographicalNames:3.0 http://schemas.kademo.nl/inspire/v3.0.1/GeographicalNames.xsd urn:x-inspire:specification:gmlas:HydroPhysicalWaters:3.0 http://schemas.kademo.nl/inspire/v3.0.1/HydroPhysicalWaters.xsd" gml:id="NL.KAD.HY-P">
  ...
  <base:member>
    <HY-P:Watercourse gml:id="NL.KAD.HY-P.NL.TOP10NL.109135330">
      ...
      <HY-P:geometry>
				<gml:Curve gml:id="CurveNL.KAD.HY-P.NL.TOP10NL.109135330" srsName="EPSG:4258"><gml:segments><gml:LineStringSegment interpolation="linear">
					<gml:posList srsName="EPSG:4258" srsDimension="2">6.924661311497654 52.387729345846942 6.924660273800471 52.387807410394736 6.924611677881166 52.388230099836932 6.92455540909 5337 52.388614173463125 6.924486954906327 52.389056968286738</gml:posList>
  ...
  <base:member>
    <HY-P:Watercourse gml:id="NL.KAD.HY-P.NL.TOP10NL.109136384">
      ...
      <HY-P:endLifespanVersion xsi:nil="true" nilReason="UNPOPULATED"/>
      <HY-P:geometry>
				<gml:Curve gml:id="CurveNL.KAD.HY-P.NL.TOP10NL.109136384" srsName="EPSG:4258"><gml:segments><gml:LineStringSegment interpolation="linear">
					<gml:posList srsName="EPSG:4258" srsDimension="2">6.924681522234544 52.386388255112685 6.924682412413779 52.386395704381698 6.924631026802207 52.386601598663027 6.92460935083 0897 52.386706421746574 6.92457612085403 52.386842388806151 6.924582235104456 52.3870186187185</gml:posList>
				</gml:LineStringSegment></gml:segments></gml:Curve>
			</HY-P:geometry>
      <HY-P:inspireId>
        <base:Identifier>
  ...
  <base:member>
    <HY-P:Watercourse gml:id="NL.KAD.HY-P.NL.TOP10NL.109136386">
      ...
      <HY-P:endLifespanVersion xsi:nil="true" nilReason="UNPOPULATED"/>
      <HY-P:geometry>
				<gml:Curve gml:id="CurveNL.KAD.HY-P.NL.TOP10NL.109136386" srsName="EPSG:4258"><gml:segments><gml:LineStringSegment interpolation="linear">
					<gml:posList srsName="EPSG:4258" srsDimension="2">6.924582235104456 52.3870186187185 6.924583372297608 52.387051395648513 6.924614962436672 52.387231043045375 6.9246535617725 9 52.387431894214394 6.924663784994586 52.387544042426441 6.924662537082993 52.387637642617022</gml:posList>
				</gml:LineStringSegment></gml:segments></gml:Curve>
			</HY-P:geometry>
      <HY-P:inspireId>
        <base:Identifier>
  ...
  <base:member>
    <HY-P:Watercourse gml:id="NL.KAD.HY-P.NL.TOP10NL.109130466">
      ...
      <HY-P:endLifespanVersion xsi:nil="true" nilReason="UNPOPULATED"/>
      <HY-P:geometry>
				<gml:Curve gml:id="CurveNL.KAD.HY-P.NL.TOP10NL.109130466" srsName="EPSG:4258"><gml:segments><gml:LineStringSegment interpolation="linear">
