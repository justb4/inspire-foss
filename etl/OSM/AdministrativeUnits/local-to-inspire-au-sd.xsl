...
Transform a local OSM ORG GML document to a INSPIRE AU SpatialDataset.

Author:  Just van den Broecke, Just Objects B.V.

Input: GML (v2) file from ogr2ogr
...
<xsl:stylesheet version="1.0"
    ...
    <!-- Use specific constants for OSM, for now with NL stuff... -->
    <xsl:include href="../../shared/xsl/constants-nl.xsl"/>
    <xsl:include href="../../shared/xsl/constants-openstreetmap.xsl"/>

	<!-- Use generic transform callable templates -->
	<xsl:include href="../../shared/xsl/common.xsl"/>

	<!-- Specific local transform from OSM local GML2 to AU -->
