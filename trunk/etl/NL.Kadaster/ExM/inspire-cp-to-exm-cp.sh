...
cp $1 $2
$BASEDIR/bin/replace-string.sh 'xmlns:CP="urn:x-inspire:specification:gmlas:CadastralParcels:3.0"' 'xmlns:CP="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:XLCP="urn:x-exml:specification:gmlas:ExMLargeCadastralParcels:1.0"' $2
...
$BASEDIR/bin/replace-string.sh 'CP:CadastralParcel' 'XLCP:CadastralParcel' $2
