...
cp $1 $2
$REPSTR 'xmlns:GN="urn:x-inspire:specification:gmlas:GeographicalNames:3.0"' 'xmlns:GN="urn:x-inspire:specification:gmlas:GeographicalNames:3.0" xmlns:XLGN="urn:x-exml:specification:gmlas:ExMLargeGeographicalNames:1.0"' $2
...
$REPSTR 'GN:NamedPlace' 'XLGN:NamedPlace' $2
