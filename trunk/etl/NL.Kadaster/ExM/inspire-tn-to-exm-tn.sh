...
cp $1 $2
$REPSTR 'xmlns:TN-RO="urn:x-inspire:specification:gmlas:RoadTransportNetwork:3.0"' 'xmlns:TN-RO="urn:x-inspire:specification:gmlas:RoadTransportNetwork:3.0" xmlns:XTN-RO="urn:x-exml:specification:gmlas:ExMLargeRoadTransportNetwork:1.0"' $2
