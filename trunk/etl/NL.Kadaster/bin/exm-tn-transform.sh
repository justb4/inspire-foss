#!/bin/bash
#
# Transforms Dutch TN data from INSPIRE GML3 to ExM GML
#
...
. $SETTINGS_SCRIPT
TRANSFORM_SCRIPT=${INSPIRE_FOSS_HOME}/etl/NL.Kadaster/ExM/inspire-tn-to-exm-tn.sh
...
for FEATURE_TYPE in $FEATURE_TYPES; do
    ...
    ${TRANSFORM_SCRIPT} $DATA_RESULT_DIR/TN_${FEATURE_TYPE}.gml $DATA_RESULT_DIR/ExM_TN_${FEATURE_TYPE}.gml
done
